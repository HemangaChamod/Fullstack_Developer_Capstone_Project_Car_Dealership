...
def initiate():
    ...
    # Sort car_make_data to ensure the correct order of insertion
    car_make_data = sorted(car_make_data, key=lambda x: x['name'])
    ...
    # Create CarModel instances after CarMakes are created
    car_model_data = [
